<?php
/**
 * Plugin Name: EtchCon Checkout for Bachs
 ...
 * Text Domain: etchcon-checkout-for-bachs
 *
...
if ( version_compare( PHP_VERSION, '8.1', '<' ) ) {
	add_action(
		...
		static function () {
			...
			echo '<div class="notice notice-error"><p>' . esc_html__( 'EtchCon Checkout for Bachs requires PHP 8.1 or newer.', 'etchcon-checkout-for-bachs' ) . '</p></div>';
		}
	);
